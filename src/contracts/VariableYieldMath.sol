...
library VariableYieldMath {
    ...
    function _fyDaiOutForVYDaiIn(
        ...
        uint256 result = uint256(fyDaiReserves) -
    ...
    function _vyDaiOutForFYDaiIn(
        ...
        uint256 result = uint256(vyDaiReserves) -
    ...
    function initialReservesValue(
        ...
        uint256 sum = (uint256(
            uint128(normalizedVYDaiReserves).pow(uint128(a), ONE)
